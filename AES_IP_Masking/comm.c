...
int comm_test (void)
{
  ...
  return ((USARTx ->SR & USART_FLAG_RXNE )!= RESET);*/
}

unsigned char comm_get (void)
{

  USART_ClearFlag(USART1, USART_FLAG_ORE );  // Reset overrun error flag, what are we going to do...?
